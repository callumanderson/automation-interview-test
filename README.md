...
The first part of this test consists of a few short exercises which should be answered using ruby. You should use the provided file to write your answer to the question. Be sure to run the solution a couple of times to confirm it works.

For the Cucumber + Watir portion of the exercise, you have been supplied a lightweight test framework which you will be expected to use. 
...
2. Navigate to the features directory (~/Projects/TechnicalTest/features)
3. Run the program “rake cucumber” to run the tests
